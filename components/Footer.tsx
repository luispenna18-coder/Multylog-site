...
const MACHINES = [
  { src: `${BASE}/RCE_20_25.webp`,      alt: "Contrabalançada STILL",    w: 110, h: 150 },
  { src: `${BASE}/EGV_16_NG.png.webp`,  alt: "Patolada STILL EGV",       w: 80,  h: 140 },
  { src: "https://www.fairchildequipment.com/wp-content/uploads/2021/05/skyjack-sj4726-sj4732-scissor-lift.jpg", alt: "Plataforma Elevatória Skyjack", w: 90, h: 145 },
  { src: `${BASE}/FM-X_17-20.webp`,     alt: "Retrátil STILL FM-X",      w: 90,  h: 160 },
];
...
export default function Footer() {
  return (
    <footer className="bg-[#1C1C1E] text-white overflow-hidden">

      {/* ── Linha 1: Logo · Marcas · Tagline ── */}
      <div className="border-b border-white/10">
        <div className="site-container py-8 lg:py-10">
          <div className="flex flex-col sm:flex-row items-center gap-8 sm:gap-12 justify-between">
            ...
            {/* KION label + logos em box */}
            <div className="flex flex-col gap-2">
              <p className="text-white/40 text-xs tracking-wide">KION Supply Chain Solutions</p>
              <div className="flex items-center gap-5 border border-white/20 rounded px-5 py-2.5">
                <div className="relative h-6 w-[72px]">
                  <Image src="/images/brands/logo-linde-mh.png" alt="Linde"
                    fill className="object-contain brightness-0 invert opacity-80" sizes="72px" />
                </div>
                <div className="relative h-6 w-[64px]">
                  <Image src="/images/brands/logo-still-t.png" alt="STILL"
                    fill className="object-contain brightness-0 invert opacity-80" sizes="64px" />
                </div>
                <div className="relative h-6 w-[64px]">
                  <Image src="/images/brands/logo-baoli-transparent.png" alt="Baoli"
                    fill className="object-contain brightness-0 invert opacity-80" sizes="64px" />
                </div>
              </div>
            </div>
            ...
            {/* Tagline */}
            <p className="text-white/60 text-sm leading-relaxed text-center sm:text-right max-w-[260px]">
      ...
      <div className="site-container py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1fr_1fr_1fr_auto] gap-12 xl:gap-16 items-end">
          ...
          <div>
            ...
            <div className="mt-5 rounded overflow-hidden w-full" style={{ height: 120 }}>
              <iframe
                src={MAP_MULTYLOG}
          ...
          {/* Máquinas decorativas */}
          <div className="hidden lg:flex items-end justify-end gap-3 self-end pl-8 xl:pl-16">
            {MACHINES.map((m) => (
              <div key={m.alt} className="relative flex-shrink-0 opacity-60"
      ...
      <div className="border-t border-white/10">
        <div className="site-container py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <a
            href={`https://wa.me/${SITE.whatsapp}?text=Olá!%20Quero%20entrar%20em%20contato%20com%20a%20Multylog.`}
            target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe59] text-white text-xs font-semibold px-5 py-2.5 rounded-full transition-colors"
          >
